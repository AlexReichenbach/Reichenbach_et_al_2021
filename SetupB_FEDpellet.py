...
filename_zScore_active = os.path.join (
    ...
    '/Users/alexreichenbach/Desktop/FiberPhotometry/AgrpCrat_striatum/FED/NAcPR', # change the path to where you want files saved
    os.path.basename(filename) + "_zall_PelletB" + ".csv")

save_to_csv_AUC = False
    # If true then input the file name
filename_AUC_active = os.path.join (
    #os.path.dirname (filename), # saves file in same directory
    '//Users/alexreichenbach/Desktop/FiberPhotometry/FED', # change the path to where you want files saved
    os.path.basename(filename) + "_AUC_Pellet" + ".csv")
